...
import 'package:metaballs/src/renderers/web/fragment_shader.dart';
import 'package:metaballs/src/renderers/web/vertex_shader.dart';
...
class ShaderProgramProvider {
  ...
  static Future<MetaballFragmentShader> createShaderInstance(WebGL2RenderingContext context) async {
    final WebGLShader fragmentShader = _compileShader(
      context,
      fragmentSource,
      WebGL2RenderingContext.FRAGMENT_SHADER,
    );
    final WebGLShader vertexShader = _compileShader(
      context,
      vertexSource,
  ...
  static WebGLShader _compileShader(
    ...
    final JSAny? status = context.getShaderParameter(shader, WebGL2RenderingContext.COMPILE_STATUS);
    if (!status.isTruthy.toDart) {
      throw Exception(

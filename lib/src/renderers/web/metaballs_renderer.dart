...
class MetaballsRenderer extends RenderBox {
  MetaballsRenderer({
    ...
    ui.platformViewRegistry.registerViewFactory(_idString, (_) {
      return _canvas;
    });
  }
  ...
  void _updateShader() {
    ...
    if (gradient == null) {
      ...
      (double, double) convertAlignment(AlignmentGeometry alignment) {
        ...
        return (
          (_lastSize.width * ((alignment.x * 0.5) + 0.5)),
          (_lastSize.height * ((-alignment.y * 0.5) + 0.5)),
        );
      }
      ...
      switch (gradient) {
        ...
        case RadialGradient():
          ...
          shader.setRadius(gradient.radius * _lastSize.shortestSide);
          shader.setGradientStart(
            alignment.$1,
            alignment.$2,
          );
